package com.jia.fingerprint.view;
...
public class FingerPrinterView extends View {
    ...
    private Bitmap mFingerRed, mFingerBlue, mFingerGary;
    ...
    private void initBitmap() {
        ...
        mFingerBlue = ((BitmapDrawable) mResources.getDrawable(R.mipmap.finger_blue)).getBitmap();
        mFingerGary = ((BitmapDrawable) mResources.getDrawable(R.mipmap.finger_gary)).getBitmap();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mFingerBlue = setScale(mFingerBlue);
        mFingerGary = setScale(mFingerGary);
        mBitWidth = mFingerRed.getWidth();
        mBitHeight = mFingerRed.getHeight();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(mFingerGary, mSrcRect, mDestRect, mBitPaint);
        if (true) {
            if (scaningCount == 0) {
                mDestRect = new Rect(0, 0, mBitWidth, (int) (mBitHeight * mFraction));
                mSrcRect = new Rect(0, 0, mBitWidth, (int) (mBitHeight * mFraction));
                canvas.drawBitmap(mFingerBlue, mSrcRect, mDestRect, mBitPaint);
